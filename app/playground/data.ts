...
if (process.env.NODE_ENV !== "production") {
  playgroundSectionSchema.array().parse(playgroundSectionsRaw);
}

export const playgroundSections = playgroundSectionsRaw as PlaygroundSection[];
